...
const ReadingResultPanel = ({
  ...
  return (
    <aside className="flex max-h-none w-full flex-col gap-4 overflow-visible lg:h-[calc(100vh-220px)] lg:max-h-[640px] lg:overflow-auto">
      ...
      {transcript && (
        <section className="rounded-2xl border border-amber-100 bg-white/85 p-5 shadow-sm">
...
const ReadingTestPage = () => {
  ...
  if (isLoading) {
    return (
      <main className="min-h-screen w-full bg-[#fbf3df] px-6 py-6 text-stone-900 lg:px-10">
  ...
  return (
    <main className="min-h-screen w-full overflow-x-hidden bg-[#fbf3df] px-6 py-4 text-stone-900 lg:px-10">
      <div className="flex w-full flex-col gap-4">
        <header className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <span className="w-fit rounded-full border border-amber-200 bg-amber-100 px-4 py-2 text-sm font-semibold text-amber-900">
        ...
        >
          <section className="flex h-[60vh] min-h-[360px] w-full max-w-full flex-col rounded-2xl border border-amber-100 bg-white/80 p-5 shadow-sm lg:h-[calc(100vh-220px)] lg:min-h-[420px] lg:max-h-[640px]">
          ...
          <section className="w-full rounded-2xl border border-amber-100 bg-white/85 p-5 shadow-sm">
              ...
              <div className="flex flex-col gap-3 sm:min-w-44">
                ...
                {isRecording && (
                  <button
                    ...
                    className="rounded-full border border-stone-300 bg-white px-6 py-3 text-sm font-semibold text-stone-800 transition hover:border-amber-400 hover:text-amber-800"
                  >
                    Finish early
                  </button>
                )}
