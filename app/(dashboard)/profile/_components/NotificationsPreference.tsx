...
export function NotificationsPreference() {
  ...
  return (
    <section
      id="notifications"
      className="scroll-mt-24 rounded-3xl border border-[#ead9bb] bg-gradient-to-br from-white via-[#fffefb] to-[#f8fafc] p-4 shadow-sm md:p-5"
    >
      ...
      <button
        type="button"
        onClick={toggle}
        className="flex w-full max-w-md items-center justify-between rounded-2xl border border-[#e8dcc4] bg-gradient-to-r from-[#fffefb] to-[#faf3e8] px-4 py-3 text-left text-sm font-bold text-[#2a241e] shadow-sm transition hover:border-[#E8920A]/30"
      >
