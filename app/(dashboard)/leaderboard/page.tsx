...
const players: PlayerRow[] = [
  { place: 2, name: "Batbold", xp: 2450 },
  { place: 1, name: "Altansukh", xp: 3320 },
  { place: 3, name: "Sarnai", xp: 2010 },
];

function getAvatarPictureUrl(name: string) {
...
export default function LeaderboardPage() {
  return (
    <div className="min-h-screen bg-[#f8f4e3] px-6 py-8">
      <h1 className="text-2xl font-bold text-[#2F372B]">Leaderboard</h1>

      <div className="mx-auto mt-8 grid max-w-115 grid-cols-3 items-end gap-4">
        {players.map((player) => {
          ...
          const avatarUrl = getAvatarPictureUrl(player.name);
